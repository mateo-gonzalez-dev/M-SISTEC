...
<head>
    ...
    <title>Departamento - SELECT</title>
    ...
    <div id="contenido">
        <form action="select.php" method="POST" name="select">
            <fieldset>
                ...
                <?php
                $sql_registros = mysqli_query($conexion,'SELECT COUNT(*) AS total FROM departamento');
                ...
                $consulta = "
                SELECT departamento.id_departamento, departamento.nombre, pais.nombre AS pais
                FROM departamento 
                ...
                if(mysqli_num_rows($ejecutar)>0){
                    ...
                    <tr>
                      ...
                      <td>
                        <a class='btn-accion btn-actualizar' href='update.php?ACTUALIZAR=$id_departamento' title='Actualizar'>
                          <i class='fa-solid fa-pen-to-square'></i>
                        </a>
                      </td>
                      <td>
                        <a class='btn-accion btn-eliminar' href='select.php?ELIMINAR=$id_departamento' title='Eliminar' onclick=\"return confirm('¿Desea eliminar este rol?');\">
                ...
                echo "<tr><td colspan='4'>No hay Departamentos registradas.</td></tr>";
              }
                ?>
            </table>
            </fieldset>
        ...
        if(isset($_GET["ELIMINAR"])){
            ...
            $eliminar = "DELETE FROM departamento WHERE id_departamento = '$borrar_id'";
