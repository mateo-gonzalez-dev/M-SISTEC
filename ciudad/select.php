    ...
    <div id="contenido">
        <form action="select.php" method="POST" name="select">
            <fieldset>
                ...
                <?php
                $sql_registros = mysqli_query($conexion,'SELECT COUNT(*) AS total FROM ciudad');
                ...
                $consulta = "
                SELECT ciudad.id_ciudad, ciudad.nombre, departamento.nombre AS departamento
                FROM ciudad
                ...
                if(mysqli_num_rows($ejecutar)>0){
                    ...
                    <tr>
                      ...
                      <td>
                        <a class='btn-accion btn-actualizar' href='update.php?ACTUALIZAR=$id_ciudad' title='Actualizar'>
                          <i class='fa-solid fa-pen-to-square'></i>
                        </a>
                      </td>
                      <td>
                        <a class='btn-accion btn-eliminar' href='select.php?ELIMINAR=$id_ciudad' title='Eliminar' onclick=\"return confirm('¿Desea eliminar este rol?');\">
                ...
                echo "<tr><td colspan='4'>No hay Ciudades registradas.</td></tr>";
              }
                ?>
            </table>
            </fieldset>
        ...
        if(isset($_GET["ELIMINAR"])){
            ...
            $eliminar = "DELETE FROM ciudad WHERE id_ciudad = '$borrar_id'";
