...
<head>
    ...
    <title>T Documento - SELECT</title>
    ...
    <div id="contenido">
        <form action="select.php" method="POST" name="select">
            <fieldset>
                ...
                <?php
                $sql_registros = mysqli_query($conexion,'SELECT COUNT(*) AS total FROM tipo_documento');
                ...
                $consulta = "SELECT * FROM tipo_documento LIMIT $desde,$por_pagina";
                ...
                if(mysqli_num_rows($ejecutar)>0){
                    ...
                    <tr>
                      ...
                      <td>$nom</td>
                      <td>
                        <a class='btn-accion btn-actualizar' href='update.php?ACTUALIZAR=$id_tipo_documento' title='Actualizar'>
                          <i class='fa-solid fa-pen-to-square'></i>
                        </a>
                      </td>
                      <td>
                        <a class='btn-accion btn-eliminar' href='select.php?ELIMINAR=$id_tipo_documento' title='Eliminar' onclick=\"return confirm('¿Desea eliminar este rol?');\">
                ...
                echo "<tr><td colspan='4'>No hay Tipos de Documento registrados.</td></tr>";
              }
        ...
        if(isset($_GET["ELIMINAR"])){
            ...
            $eliminar = "DELETE FROM tipo_documento WHERE id_tipo_documento = '$borrar_id'";
