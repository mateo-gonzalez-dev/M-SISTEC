...
<body>
    ...
    <?php
      ...
      if (isset($_GET['ACTUALIZAR'])) {
          ...
          $consulta = "SELECT * FROM tipo_identidad WHERE id_tipo_identidad = '$editar_id'";
    ...
    <form name="update" method="POST" action="">
      <fieldset>
        ...
        <div class="inputs-formularios">
            <label for="txt_idrol">ID Tipo de Identidad:</label>
            <input type="text" name="txt_idrol" value="<?php echo $id_tipo_identidad; ?>" readonly>
        </div>
        
        <div class="inputs-formularios">
            <label for="txt_nombre">Nombre del tipo de Identidad:</label>
    ...
    <?php
      ...
      if (isset($_POST['actualizar'])) {
          ...
          if (!empty($nom)) {
              $actualizar = "UPDATE TIPO_IDENTIDAD SET TIPO_IDENTIDAD='$nom' WHERE ID_TIPO_IDENTIDAD='$id'";
              $ejecutar = mysqli_query($conexion, $actualizar) or die(mysqli_error($conexion));

              echo "<script>alert(' Tipo de Identidad actualizado correctamente');</script>";
