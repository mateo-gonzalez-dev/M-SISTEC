    ...
    <div id="contenido">
        <form action="select.php" method="POST" name="select">
            <fieldset>
                ...
                <?php
                $sql_registros = mysqli_query($conexion,'SELECT COUNT(*) AS total FROM pais');
                ...
                $consulta = "SELECT * FROM pais LIMIT $desde,$por_pagina";
                ...
                if(mysqli_num_rows($ejecutar)>0){
                    ...
                    <tr>
                      ...
                      <td>$nom</td>
                      <td>
                        <a class='btn-accion btn-actualizar' href='update.php?ACTUALIZAR=$id_pais' title='Actualizar'>
                          <i class='fa-solid fa-pen-to-square'></i>
                        </a>
                      </td>
                      <td>
                        <a class='btn-accion btn-eliminar' href='select.php?ELIMINAR=$id_pais' title='Eliminar' onclick=\"return confirm('¿Desea eliminar este rol?');\">
                ...
                echo "<tr><td colspan='4'>No hay Paises registradas.</td></tr>";
              }
                ?>
            </table>
            </fieldset>
        ...
        if(isset($_GET["ELIMINAR"])){
            ...
            $eliminar = "DELETE FROM pais WHERE id_pais = '$borrar_id'";
