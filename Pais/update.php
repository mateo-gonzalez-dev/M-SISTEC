...
<body>
    ...
    <?php
      ...
      if (isset($_GET['ACTUALIZAR'])) {
          ...
          $consulta = "SELECT * FROM pais WHERE id_pais = '$editar_id'";
    ...
    <form name="update" method="POST" action="">
      <fieldset>
        ...
        <div class="inputs-formularios">
            <label for="txt_idrol">ID Pais:</label>
            <input type="text" name="txt_idrol" value="<?php echo $id_pais; ?>" readonly>
        </div>
        
        <div class="inputs-formularios">
            <label for="txt_nombre">Nombre del Pais:</label>
    ...
    <?php
      ...
      if (isset($_POST['actualizar'])) {
          ...
          if (!empty($nom)) {
              $actualizar = "UPDATE PAIS SET NOMBRE='$nom' WHERE ID_PAIS='$id'";
              $ejecutar = mysqli_query($conexion, $actualizar) or die(mysqli_error($conexion));

              echo "<script>alert('Pais actualizada correctamente');</script>";
