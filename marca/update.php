...
<body>
    ...
    <?php
      ...
      if (isset($_GET['ACTUALIZAR'])) {
          ...
          $consulta = "SELECT * FROM marca WHERE id_marca = '$editar_id'";
    ...
    <form name="update" method="POST" action="">
      <fieldset>
        ...
        <div class="inputs-formularios">
            <label for="txt_idrol">ID Marca:</label>
            <input type="text" name="txt_idrol" value="<?php echo $id_marca; ?>" readonly>
        </div>
        
        <div class="inputs-formularios">
            <label for="txt_nombre">Nombre de la Marca:</label>
    ...
    <?php
      ...
      if (isset($_POST['actualizar'])) {
          ...
          if (!empty($nom)) {
              $actualizar = "UPDATE MARCA SET NOMBRE_MARCA='$nom' WHERE ID_MARCA='$id'";
              $ejecutar = mysqli_query($conexion, $actualizar) or die(mysqli_error($conexion));

              echo "<script>alert('Marca actualizada correctamente');</script>";
